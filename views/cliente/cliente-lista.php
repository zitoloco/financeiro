                    ...
                    <div class="card">
                        ...
                        <div class="content">
                            <div class="toolbar">
                                ...
                                <h4 class="title"><b><i class="ti-clipboard"></i> Lista de Clientes</b>
                                    <a href="<?php echo HOME_URI ?>/cliente/cad/" class="btn btn-info btn-fill btn-icon pull-right"><span class="ti-plus"></span></a>
                                </h4>
                                <hr>
                            </div>
                                ...
                                <table id="datatables" class="table table-striped table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    <?php foreach ($lista as $fetch_userdata): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo HOME_URI ?>/cliente/cad/edit/<?php echo $fetch_userdata['idPessoa'] ?>" class="btn btn-simple btn-warning btn-icon edit"><i class="ti-pencil-alt"></i></a>
                                                <a href="<?php echo HOME_URI ?>/cliente/cad/del/<?php echo $fetch_userdata['idPessoa'] ?>" class="btn btn-simple btn-danger btn-icon remove"><i class="ti-close"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach;?> 
                                    </tbody>
