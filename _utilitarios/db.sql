CREATE DATABASE IF NOT EXISTS `rpuglielli` CHARACTER SET utf8;

CREATE TABLE IF NOT EXISTS `rpuglielli`.`noticias` (
...
CREATE TABLE IF NOT EXISTS `rpuglielli`.`users` (
